...
public class Practice12MeasureTextView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(text1,50,100,paint1);
        canvas.drawText(text2,50+paint1.measureText(text1),100,paint2);
        canvas.drawText(text3,50+paint1.measureText(text1)+
                paint2.measureText(text2),100,paint1);
    }
}
